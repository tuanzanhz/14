...
function loadVideo(keyword){
    var YOUTUBE_API ="https://content.googleapis.com/youtube/v3/search?q=" + keyword + "&type=video&maxResults=9&part=snippet&key=AIzaSyDaR_U9ruoA-BLSaGBNyf4DTPGxAixftXA";
    ...
    xhr.onreadystatechange = function(){
        if(this.readyState == 4 && this.status == 200){
            ...
            for (var i=0; i < responseJson.items.length;i++){
                ...
                var videoDescripttion = responseJson.items[i].snippet.description;
